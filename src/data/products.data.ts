...
export class Products {
  public static readonly all = [
    ...
    new Product("Fettuccine Pasta", Unit.g),
    ...
    new Product("Peas", Unit.g),
    new Product("Lemon Juice", Unit.ml),
    new Product("Penne Pasta", Unit.g),
    new Product("Pumpkin Puree", Unit.g),
    new Product("Quark", Unit.g),
    new Product("Oatmeal", Unit.g),
    new Product("Honey", Unit.ml),
  ];
